...
function clik (btn){
  btn.textContent == "Iya " ? img.src = "B.gif" : img.src = "B.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "250px"
  ctn.style.width = "270px"
  return btn.textContent == "Iya " ? kata.textContent = "nih buat Almukk 💝💖" : kata.textContent = "Gamau tau pokoknya harus mau😠"
...
function content(){
  ...
  kata.textContent = "Hay, cuma mau ucapin, HAPPY VALENTINE DAYS 😊"
}
